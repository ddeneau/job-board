    ...
    return (
        <nav className={navClass}>
            <ul className={ulClass}>
                <li className={liClass}><Link className={linkClass} to="/">Home</Link></li>
                <li className={liClass}><Link className={linkClass} to="/board">Jobs</Link></li>
                <li className={liClass}><Link className={linkClass} to="/users">Users</Link></li>
                <li className={liClass}><Link className={linkClass} to="/profile">Profile</Link></li>
            </ul>
            <Outlet />
        </nav>
    );
